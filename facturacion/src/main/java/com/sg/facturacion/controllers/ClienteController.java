...
import com.sg.validators.CedulaValidator;
...
public class ClienteController {
    ...
    public String addNew(Clientes cliente, Model model) {
        try {
            if (cliente.getCedula() != null && !CedulaValidator.validarCedula(cliente.getCedula())) {
                model.addAttribute("errorMessage", "La cédula ingresada no es válida.");
